...
function preload(){
  ...
  groundImage = loadImage("flor.png");
...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   ...
   obstacle.velocityX = -6;
    ...
    switch(rand) {
      case 1: obstacle.addImage(slime1.png)
              break
      case 2: obstacle.addImage(slime2.png);
              break;
      case 3: obstacle.addImage(slime3.png);
              break;
    case 4: obstacle.addImage(slime4.png);
              break;
      default: break;
    }
